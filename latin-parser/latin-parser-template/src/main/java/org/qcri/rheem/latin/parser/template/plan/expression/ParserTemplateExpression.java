package org.qcri.rheem.latin.parser.template.plan.expression;

import org.qcri.rheem.latin.core.plan.LatinElement;
import org.qcri.rheem.latin.core.plan.expression.LatinExpression;

public class ParserTemplateExpression extends LatinExpression{
    public ParserTemplateExpression(String name) {
        super(name);
    }

    public ParserTemplateExpression(LatinExpression element) {
        super(element);
    }
