...
public class RecordDinamic implements Serializable, Copyable<RecordDinamic> {
    ...
    public static boolean stadistic = false;

    private Map<String, Object> values;

    private String[] keys;

    private Pair<Integer, Integer> uses;
    ...
    public String toString() {
        String used = "";
        if(stadistic && this.uses != null){
            used = "<"+this.uses.first+","+this.uses.second+">";
        }
    ...
    public void setUse(int fin, int max){
        this.uses = new Pair<>(fin, max);
    }
}