...
/**
 * All exceptions in Pig are encapsulated in the <code>LatinException</code>
 ...
 * location = null
 */
public class LatinException extends IOException {
    ...
    public static byte determineErrorSource(int errCode) {
    	if(errCode >= 100 && errCode <= 1999) {
    		return LatinException.INPUT;
    	} else if (errCode >= 2000 && errCode <= 2999) {
    		return LatinException.BUG;
    	} else if (errCode >= 3000 && errCode <= 4999) {
    		return LatinException.USER_ENVIRONMENT;
    	} else if (errCode >= 5000 && errCode <= 6999) {
    		return LatinException.REMOTE_ENVIRONMENT;
    	}
    	return LatinException.ERROR;
    }
    ...
    /**
     * Create a new LatinException with null as the error message.
     */
    ...
    /**
     * Create a new LatinException with the specified message.
     *
     ...
     */
    public LatinException(String message, SourceLocation location) {
        super(message);
        sourceLocation = location;
    }
    
    /**
     * Create a new LatinException with the specified cause.
     *
    ...
    /**
     * Create a new LatinException with the specified message and cause.
     *
     * @param message - The error message (which is saved for later retrieval by the <link>Throwable.getMessage()</link> method) shown to the user 
     * @param cause - The cause (which is saved for later retrieval by the <link>Throwable.getCause()</link> method) indicating the source of this exception. A null value is permitted, and indicates that the cause is nonexistent or unknown.
     */
     ...
     */
    public LatinException(String message, int errCode) {
        this(message);
        errorCode = errCode;
    }
     ...
     * @param location - The <link>SourceLocation</link> that generated this error.
     */
    public LatinException(String message, int errCode, SourceLocation location) {
     ...
     * @param cause - The cause (which is saved for later retrieval by the <link>Throwable.getCause()</link> method) indicating the source of this exception. A null value is permitted, and indicates that the cause is nonexistent or unknown. 
     */
    public LatinException(String message, int errCode, Throwable cause) {
        this(message, cause);
        errorCode = errCode;
    }
     ...
     * @param location - The <link>SourceLocation</link> that generated this error.
     */
    public LatinException(String message, int errCode, Throwable cause, SourceLocation location) {
        this(message, cause);
        errorCode = errCode;
        sourceLocation = location;
    }
     ...
     */
    public LatinException(String message, int errCode, byte errSrc) {
     ...
     * @param location - The <link>SourceLocation</link> that generated this error.
     */
    public LatinException(String message, int errCode, byte errSrc, SourceLocation location) {
     ...
     * @param cause - The cause (which is saved for later retrieval by the <link>Throwable.getCause()</link> method) indicating the source of this exception. A null value is permitted, and indicates that the cause is nonexistent or unknown. 
     */
    public LatinException(String message, int errCode, byte errSrc, Throwable cause) {
     ...
     * @param location - The <link>SourceLocation</link> that generated this error.
     */
    public LatinException(String message, int errCode, byte errSrc, Throwable cause, SourceLocation location) {
     ...
     */
    public LatinException(String message, int errCode, boolean retry) {
        this(message, errCode);
        retriable = retry;
    }
     ...
     * @param retry - If the exception is retriable or not
     */
    public LatinException(String message, int errCode, byte errSrc, boolean retry) {
     ...
     */
    public LatinException(String message, int errCode, byte errSrc, boolean retry, String detailedMsg) {
     ...
     * @param detailedMsg - The detailed message shown to the developer 
     */
    public LatinException(String message, int errCode, byte errSrc, boolean retry, String detailedMsg, SourceLocation location) {
        this(message, errCode, errSrc, retry);
        detailedMessage = detailedMsg;
        sourceLocation = location;
    }
    ...
    /**
     * Create a new LatinException with the specified message, error code, error source, retriable or not, detalied message for the developer and cause.
     *
     * @param message - The error message (which is saved for later retrieval by the <link>Throwable.getMessage()</link> method) shown to the user 
     * @param errCode - The error code shown to the user 
     * @param errSrc - The error source 
     ...
     * @param cause - The cause (which is saved for later retrieval by the <link>Throwable.getCause()</link> method) indicating the source of this exception. A null value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public LatinException(String message, int errCode, byte errSrc, boolean retry, String detailedMsg, Throwable cause) {
        super(message, cause);
        errorCode = errCode;
        errorSource = errSrc;
        retriable = retry;
     ...
     * @param location - The <link>SourceLocation</link> that generated this error.
     */
    public LatinException(String message, int errCode, byte errSrc, boolean retry, String detailedMsg, Throwable cause, SourceLocation location) {
        super(message, cause);
        errorCode = errCode;
        errorSource = errSrc;
        retriable = retry;
    ...
    /**
     * Check if this LatinException is marked as the ones whose message is to be
     ...
     * @return true if this latin exception is marked as appropriate to be
