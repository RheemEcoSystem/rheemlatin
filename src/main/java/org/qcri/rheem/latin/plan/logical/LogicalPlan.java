...
import org.qcri.rheem.latin.util.HashOutputStream;
...
public class LogicalPlan extends BaseOperatorPlan {
    ...
    public void validate(LatinContext latinContext, String scope, boolean skipInputOutputValidation)
            throws FrontendException {


    }
    
    public void optimize(LatinContext latinContext) throws FrontendException {
