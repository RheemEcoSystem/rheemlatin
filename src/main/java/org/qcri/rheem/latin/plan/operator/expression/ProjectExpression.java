    ...
    public void setColumnNumberFromAlias() throws FrontendException {
        if(isRangeProject){
            ...
            if(startCol < 0){
                ...
                throw new PlanValidationException(this, msg, 2270, LatinException.BUG);
            }
            ...
            if(endCol > 0 && startCol > endCol){
                ...
                throw new PlanValidationException(this, msg, 1127, LatinException.INPUT);
            }
        }else{
        ...
        if (attachedRelationalOp instanceof LOGenerate && plan.getSuccessors(this)==null) {
            if (!(findReferent() instanceof LOInnerLoad)||
                ...
                if (innerLoads.get(0).getProjection().getFieldSchema().schema!=null &&
                    ...
                    LogicalSchema.LogicalFieldSchema originalTupleFieldSchema = innerLoads.get(0).getProjection().getFieldSchema().schema.getField(0);
                    LogicalSchema.LogicalFieldSchema newTupleFieldSchema = new LogicalSchema.LogicalFieldSchema(originalTupleFieldSchema.alias,
                ...
                if(schema == null){
                    ...
                    if (isRangeProject && endCol!=-1){
                        ...
                        for(int i = startCol; i <= endCol; i++){
                            ...
                            innerSchema.addField(new LogicalSchema.LogicalFieldSchema(null, null, DataType.BYTEARRAY));
                        }
