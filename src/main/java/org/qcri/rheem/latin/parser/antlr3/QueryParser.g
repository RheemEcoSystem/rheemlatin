...
//import org.qcri.rheem.latin.parser.LatinMacro
...
private Set<String> operators_name = new HashSet<String>();
...
op_clause : many_unary_op
;


many_unary_op : OPERATOR PARAM_OPERATOR? identifier_plus+ COMA cond (COMA cond)*
