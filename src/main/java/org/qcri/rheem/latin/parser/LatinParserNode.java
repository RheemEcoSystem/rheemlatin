...
public class LatinParserNode extends CommonTree {
    ...
    public LatinParserNode(Token t, String fileName, int lineOffset) {
        super(t);
    ...
    public LatinParserNode(Token t, String fileName, Token start) {
        this(t, fileName, 0);
        this.startLine = start.getLine();
    }

    public LatinParserNode(LatinParserNode node) {
        super(node);
    ...
    public Tree dupNode() {
        return new LatinParserNode(this);
    }
