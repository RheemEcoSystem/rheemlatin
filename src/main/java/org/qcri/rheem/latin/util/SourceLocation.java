...
public class SourceLocation {
    ...
    private LatinParserNode node; // corresponding parser tree node
    ...
    public SourceLocation(LatinParserNode tree) {
    ...
    public String toString() {
        ...
        if (node != null) {
            LatinParserNode.InvocationPoint pt = node.getNextInvocationPoint();
            while (pt != null) {
