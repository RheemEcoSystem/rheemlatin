...
public class StreamingCommandUtils {
    ...
    private final LatinContext latinContext;

    public StreamingCommandUtils(LatinContext latinContext) {
        this.latinContext = latinContext;
    }

    public static String[] splitArgs(String command) throws ParserException {
    ...
    public void checkAutoShipSpecs(StreamingCommand command, String[] argv)
    ...
    private static boolean isQuotedString(String s) {
     ...
     private boolean inSkipPaths(String file) {
         for (String skipPath : latinContext.getPathsToSkip()) {
