 ...
 * separate from {@link Schema}, which is an internal Latin representation of a schema.
 * @since Latin 0.7
 */
public class ResourceSchema implements Serializable {
    ...
    public static class ResourceFieldSchema implements Serializable {
        ...
        /**
         * Construct using a {@link Schema.FieldSchema} as the template.
        ...
        public ResourceFieldSchema(Schema.FieldSchema fieldSchema) {
            ...
            description = "autogenerated from Latin Field Schema";
        ...
        /**
         * Construct using a {@link LogicalSchema.LogicalFieldSchema} as the template.
         * @param fieldSchema fieldSchema to copy from
         */
        ...
        public static void throwInvalidSchemaException() throws FrontendException {
            ...
            "bag schema must have tuple as its field", errCode, LatinException.BUG);
        }
