...
import rheem.impl.PigContext;
import rheem.impl.builtin.GFAny;
import rheem.impl.logicalLayer.FrontendException;
import rheem.impl.streaming.StreamingCommand;
import rheem.impl.streaming.StreamingCommand.HandleSpec;
import rheem.impl.util.MultiMap;
import rheem.impl.util.NumValCarrier;
import rheem.impl.plan.PlanValidationException;
import rheem.newplan.Operator;
import rheem.newplan.logical.expression.AddExpression;
import rheem.newplan.logical.expression.AndExpression;
import rheem.newplan.logical.expression.BinCondExpression;
import rheem.newplan.logical.expression.CastExpression;
import rheem.newplan.logical.expression.ConstantExpression;
import rheem.newplan.logical.expression.DereferenceExpression;
import rheem.newplan.logical.expression.DivideExpression;
import rheem.newplan.logical.expression.EqualExpression;
import rheem.newplan.logical.expression.GreaterThanEqualExpression;
import rheem.newplan.logical.expression.GreaterThanExpression;
import rheem.newplan.logical.expression.IsNullExpression;
import rheem.newplan.logical.expression.LessThanEqualExpression;
import rheem.newplan.logical.expression.LessThanExpression;
import rheem.newplan.logical.expression.LogicalExpression;
import rheem.newplan.logical.expression.LogicalExpressionPlan;
import rheem.newplan.logical.expression.MapLookupExpression;
import rheem.newplan.logical.expression.ModExpression;
import rheem.newplan.logical.expression.MultiplyExpression;
import rheem.newplan.logical.expression.NegativeExpression;
import rheem.newplan.logical.expression.NotEqualExpression;
import rheem.newplan.logical.expression.NotExpression;
import rheem.newplan.logical.expression.OrExpression;
import rheem.newplan.logical.expression.ProjectExpression;
import rheem.newplan.logical.expression.RegexExpression;
import rheem.newplan.logical.expression.ScalarExpression;
import rheem.newplan.logical.expression.SubtractExpression;
import rheem.newplan.logical.expression.UserFuncExpression;
import rheem.newplan.logical.relational.LOCogroup;
import rheem.newplan.logical.relational.LOCube;
import rheem.newplan.logical.relational.LOFilter;
import rheem.newplan.logical.relational.LOForEach;
import rheem.newplan.logical.relational.LOGenerate;
import rheem.newplan.logical.relational.LOLimit;
import rheem.newplan.logical.relational.LOJoin;
import rheem.newplan.logical.relational.LOSort;
import rheem.newplan.logical.relational.LORank;
import rheem.newplan.logical.relational.LOSplitOutput;
import rheem.newplan.logical.relational.LogicalPlan;
import rheem.newplan.logical.relational.LogicalRelationalOperator;
import rheem.newplan.logical.relational.LogicalSchema;
import rheem.newplan.logical.relational.LogicalSchema.LogicalFieldSchema;
import rheem.newplan.logical.relational.LOCogroup.GROUPTYPE;
import rheem.newplan.logical.relational.LOJoin.JOINTYPE;
import rheem.FuncSpec;
